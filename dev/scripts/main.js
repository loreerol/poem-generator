...
let wordForPoems = [
            ...
            {word: `fortress`, value: `fv`, type:`noun`},
            {word: `backyard`, value: `fv`, type:`noun`},
            ...
            {word: `decipher`, value: `fv`, type:`verb`},
            {word: `mothering`, value: `fv`, type:`verb`},
            {word: `tearing`, value: `fv`, type:`verb`},
            {word: `twinkling`, value: `fv`, type:`verb`},
            {word: `feasting`, value: `fv`, type:`verb`},
            {word: `dumped`, value: `fv`, type:`verb`},
            {word: `admitting`, value: `fv`, type:`verb`},
            {word: `remember`, value: `fv`, type:`verb`},
            {word: `galloping`, value: `fv`, type:`verb`},
            {word: `wandering`, value: `fv`, type:`verb`},
            {word: `plough`, value: `fv`, type:`verb`},
            {word: `digitally`, value: `fv`, type:`verb`},
            {word: `calculating`, value: `fv`, type:`verb`},
            {word: `love`, value: `s`, type:`noun`},
            {word: `soul`, value: `s`, type:`noun`},
            {word: `breath`, value: `s`, type:`noun`},
            {word: `tenderness`, value: `s`, type:`noun`},
            {word: `stars`, value: `s`, type:`noun`},
            {word: `eyes`, value: `s`, type:`noun`},
            {word: `desire`, value: `s`, type:`noun`},
            {word: `roses`, value: `s`, type:`noun`},
            {word: `waiting`, value: `s`, type:`noun`},
            {word: `cheak`, value: `s`, type:`noun`},
            {word: `longing`, value: `s`, type:`noun`},
            {word: `passionately`, value: `s`, type:`adjective`},
            {word: `heavenly`, value: `s`, type:`adjective`},
            {word: `sweet`, value: `s`, type:`adjective`},
            {word: `aching`, value: `s`, type:`adjective`},
            {word: `unaware`, value: `s`, type:`adjective`},
            {word: `luscious`, value: `s`, type:`adjective`},
            {word: `fragrant`, value: `s`, type:`adjective`},
